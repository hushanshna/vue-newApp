<template>
   <div class="foot-btn" >
       <ul>
          <router-link tag="li" class="home" active-class="active-home" to='/home'></router-link>
          <router-link tag="li" class="write" active-class="active-write" to='/buycar'></router-link>
          <router-link tag="li" class="my" active-class="active-my" to='/user'></router-link>
